...
<div className="template__place">
 ...
 <h4 className="card__name">{props.title}</h4><div className="card__like-block"><button type="button" className={`card__like ${(props.cardLiked !== undefined) && 'card__like card__like_active'}`}></button><p className="card__like-number">{props.likes}</p></div>
      </figcaption>
    </figure>
  </div>
 );
